<template>
  <div class="parallax-container">
    ...
    <div id="employment" class="solid-block-four content-section">
      <div class="content">
    ...
    <div id="skills" class="solid-block-two content-section">
      <div class="content">
    ...
    <div id="portfolio" class="solid-block-three content-section">
      <div class="content">
